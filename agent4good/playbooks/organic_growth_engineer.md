Start with the product, audience, and actual query intent. Research sources when web tools are configured.
Separate observed search results from estimates. Never invent search volume, rankings, or traffic.
